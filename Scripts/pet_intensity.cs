...
namespace RazorEnhanced
{
    public class IntensityInspect
    {
        ...
        public static Dictionary<string, string> Parse(string input, bool trainedPet)
        {
            ...
            if (trainedPet)
            {
            keys = new List<string> { "name", "progress", "hits", "stamina", "mana", "strength", "dexterity", 
            ...
            {
            keys = new List<string> { "name", "hits", "stamina", "mana", "strength", "dexterity", 
                                        "intelligence", "bardingdifficulty", "hpregen", "staminaregen", "manaregen", 
                                        "resistphysical", "resistfire", "resistcold", "resistpoison", "resistenergy", 
                                        "damagephysical", "damagefire", "damagecold", "damagepoison", "damageenergy", 
                                        "damage", "wrestling", "tactics", "resistingspells", "anatomy", "healing", 
        ...
        public void CreateMenuInstance(Pet myPet, Dictionary<string, string> parseDict, Dictionary<string, string[]> petDict)
        {
            ...
            Gumps.AddBackground(ref gump, 0, 0, 530, 737, 5054);
            ...
            Gumps.AddImageTiled(ref gump, 10, 70, 510, 117, 2624);
            
            //////////// STATS & ATTRIBUTES //////////////
            Gumps.AddImageTiled(ref gump, 10, 193, 510, 25, 2624);
            Gumps.AddImageTiled(ref gump, 10, 223, 248, 80, 2624);
            Gumps.AddImageTiled(ref gump, 267, 223, 253, 80, 2624);

            //////////// RESISTANCES //////////////
            Gumps.AddImageTiled(ref gump, 10, 308, 510, 25, 2624);
            Gumps.AddImageTiled(ref gump, 24, 338, 88, 25, 2624);
            Gumps.AddImageTiled(ref gump, 122, 338, 88, 25, 2624);
            Gumps.AddImageTiled(ref gump, 220, 338, 88, 25, 2624);
            Gumps.AddImageTiled(ref gump, 318, 338, 88, 25, 2624);
            Gumps.AddImageTiled(ref gump, 416, 338, 88, 25, 2624);

            Gumps.AddImageTiled(ref gump, 24, 368, 88, 25, 2624);
            Gumps.AddImageTiled(ref gump, 122, 368, 88, 25, 2624);
            Gumps.AddImageTiled(ref gump, 220, 368, 88, 25, 2624);
            Gumps.AddImageTiled(ref gump, 318, 368, 88, 25, 2624);
            Gumps.AddImageTiled(ref gump, 416, 368, 88, 25, 2624);

             //////////// DAMAGE //////////////
            Gumps.AddImageTiled(ref gump, 10, 398, 510, 25, 2624);
            Gumps.AddImageTiled(ref gump, 24, 428, 88, 25, 2624);
            Gumps.AddImageTiled(ref gump, 122, 428, 88, 25, 2624);
            Gumps.AddImageTiled(ref gump, 220, 428, 88, 25, 2624);
            Gumps.AddImageTiled(ref gump, 318, 428, 88, 25, 2624);
            Gumps.AddImageTiled(ref gump, 416, 428, 88, 25, 2624);
            
            Gumps.AddImageTiled(ref gump, 24, 458, 88, 25, 2624);
            Gumps.AddImageTiled(ref gump, 122, 458, 88, 25, 2624);
            Gumps.AddImageTiled(ref gump, 220, 458, 88, 25, 2624);
            Gumps.AddImageTiled(ref gump, 318, 458, 88, 25, 2624);
            Gumps.AddImageTiled(ref gump, 416, 458, 88, 25, 2624);

             //////////// SKILLS //////////////
            Gumps.AddImageTiled(ref gump, 10, 490, 510, 25, 2624);
            Gumps.AddImageTiled(ref gump, 14, 520, 85, 25, 2624);
            Gumps.AddImageTiled(ref gump, 101, 520, 35, 25, 2624);
            Gumps.AddImageTiled(ref gump, 141, 520, 85, 25, 2624);
            Gumps.AddImageTiled(ref gump, 228, 520, 35, 25, 2624);
            Gumps.AddImageTiled(ref gump, 268, 520, 85, 25, 2624);
            Gumps.AddImageTiled(ref gump, 355, 520, 35, 25, 2624);
            Gumps.AddImageTiled(ref gump, 395, 520, 85, 25, 2624);
            Gumps.AddImageTiled(ref gump, 482, 520, 35, 25, 2624);

            Gumps.AddImageTiled(ref gump, 14, 550, 85, 25, 2624);
            Gumps.AddImageTiled(ref gump, 101, 550, 35, 25, 2624);
            Gumps.AddImageTiled(ref gump, 141, 550, 85, 25, 2624);
            Gumps.AddImageTiled(ref gump, 228, 550, 35, 25, 2624);
            Gumps.AddImageTiled(ref gump, 268, 550, 85, 25, 2624);
            Gumps.AddImageTiled(ref gump, 355, 550, 35, 25, 2624);
            Gumps.AddImageTiled(ref gump, 395, 550, 85, 25, 2624);
            Gumps.AddImageTiled(ref gump, 482, 550, 35, 25, 2624);

            Gumps.AddImageTiled(ref gump, 14, 580, 85, 25, 2624);
            Gumps.AddImageTiled(ref gump, 101, 580, 35, 25, 2624);
            Gumps.AddImageTiled(ref gump, 141, 580, 85, 25, 2624);
            Gumps.AddImageTiled(ref gump, 228, 580, 35, 25, 2624);
            Gumps.AddImageTiled(ref gump, 268, 580, 85, 25, 2624);
            Gumps.AddImageTiled(ref gump, 355, 580, 35, 25, 2624);
            Gumps.AddImageTiled(ref gump, 395, 580, 85, 25, 2624);
            Gumps.AddImageTiled(ref gump, 482, 580, 35, 25, 2624);

            Gumps.AddImageTiled(ref gump, 14, 610, 85, 25, 2624);
            Gumps.AddImageTiled(ref gump, 101, 610, 35, 25, 2624);
            Gumps.AddImageTiled(ref gump, 141, 610, 85, 25, 2624);
            Gumps.AddImageTiled(ref gump, 228, 610, 35, 25, 2624);
            Gumps.AddImageTiled(ref gump, 268, 610, 85, 25, 2624);
            Gumps.AddImageTiled(ref gump, 355, 610, 35, 25, 2624);
            Gumps.AddImageTiled(ref gump, 395, 610, 85, 25, 2624);
            Gumps.AddImageTiled(ref gump, 482, 610, 35, 25, 2624);

            Gumps.AddImageTiled(ref gump, 14, 640, 85, 25, 2624);
            Gumps.AddImageTiled(ref gump, 101, 640, 35, 25, 2624);
            Gumps.AddImageTiled(ref gump, 141, 640, 85, 25, 2624);
            Gumps.AddImageTiled(ref gump, 228, 640, 35, 25, 2624);
            Gumps.AddImageTiled(ref gump, 268, 640, 85, 25, 2624);
            Gumps.AddImageTiled(ref gump, 355, 640, 35, 25, 2624);
            
             //////////// MISC //////////////
            Gumps.AddImageTiled(ref gump, 10, 670, 510, 25, 2624);

            Gumps.AddImageTiled(ref gump, 19, 700, 100, 25, 2624);
            Gumps.AddImageTiled(ref gump, 124, 700, 60, 25, 2624);

            Gumps.AddImageTiled(ref gump, 193, 700, 100, 25, 2624);
            Gumps.AddImageTiled(ref gump, 298, 700, 40, 25, 2624);

            Gumps.AddImageTiled(ref gump, 349, 700, 100, 25, 2624);
            Gumps.AddImageTiled(ref gump, 454, 700, 55, 25, 2624);
            
            //////////// TITLE //////////////
            Gumps.AddAlphaRegion(ref gump, 10, 10, 480, 717);
            Gumps.AddAlphaRegion(ref gump, 490, 34, 30, 693);
            ...
            //////////// INTENSITY RATING //////////////
            Gumps.AddHtml(ref gump, 10, 42, 512, 20, $"<CENTER><BASEFONT COLOR=#42a5ff>INTENSITY SUMMARY</BASEFONT></CENTER>", false, false);
            ...
            //////////// STATS & ATTRIBUTES //////////////
            Gumps.AddHtml(ref gump, 10, 195, 512, 20, $"<CENTER><BASEFONT COLOR=#42a5ff>STATS & ATTRIBUTES</BASEFONT></CENTER>", false, false);
            Gumps.AddHtml(ref gump, 15, 230, 125, 20, $"<RIGHT><BASEFONT COLOR=#ffffff>Strength :</BASEFONT></RIGHT>", false, false);
            Gumps.AddHtml(ref gump, 140, 230, 125, 20, $"<LEFT><BASEFONT COLOR=#ffffff>{myPet.Strength}</BASEFONT></LEFT>", false, false);
            Gumps.AddHtml(ref gump, 15, 255, 125, 20, $"<RIGHT><BASEFONT COLOR=#ffffff>Dexterity :</BASEFONT></RIGHT>", false, false);
            Gumps.AddHtml(ref gump, 140, 255, 125, 20, $"<LEFT><BASEFONT COLOR=#ffffff>{myPet.Dexterity}</BASEFONT></LEFT>", false, false);
            Gumps.AddHtml(ref gump, 15, 280, 125, 20, $"<RIGHT><BASEFONT COLOR=#ffffff>Intelligence :</BASEFONT></RIGHT>", false, false);
            Gumps.AddHtml(ref gump, 140, 280, 125, 20, $"<LEFT><BASEFONT COLOR=#ffffff>{myPet.Intelligence}</BASEFONT></LEFT>", false, false);
            Gumps.AddHtml(ref gump, 242, 230, 125, 20, $"<RIGHT><BASEFONT COLOR=#ffffff>Hit Points :</BASEFONT></RIGHT>", false, false);
            Gumps.AddHtml(ref gump, 367, 230, 125, 20, $"<LEFT><BASEFONT COLOR=#ffffff>{myPet.HitsMin} / {myPet.HitsMax}</BASEFONT></LEFT>", false, false);
            Gumps.AddHtml(ref gump, 242, 255, 125, 20, $"<RIGHT><BASEFONT COLOR=#ffffff>Stamina :</BASEFONT></RIGHT>", false, false);
            Gumps.AddHtml(ref gump, 367, 255, 125, 20, $"<LEFT><BASEFONT COLOR=#ffffff>{myPet.StaminaMin} / {myPet.StaminaMax}</BASEFONT></LEFT>", false, false);
            Gumps.AddHtml(ref gump, 242, 280, 125, 20, $"<RIGHT><BASEFONT COLOR=#ffffff>Mana :</BASEFONT></RIGHT>", false, false);
            Gumps.AddHtml(ref gump, 367, 280, 125, 20, $"<LEFT><BASEFONT COLOR=#ffffff>{myPet.ManaMin} / {myPet.ManaMax}</BASEFONT></LEFT>", false, false);

            //////////// RESISTANCES //////////////
            Gumps.AddHtml(ref gump, 10, 310, 512, 20, $"<CENTER><BASEFONT COLOR=#42a5ff>RESISTANCES</BASEFONT></CENTER>", false, false);
            Gumps.AddHtml(ref gump, 24, 340, 88, 25, $"<CENTER><BASEFONT COLOR=#ffffff>Physical</BASEFONT></CENTER>", false, false);
            Gumps.AddHtml(ref gump, 122, 340, 88, 25, $"<CENTER><BASEFONT COLOR=#ffffff>Fire</BASEFONT></CENTER>", false, false);
            Gumps.AddHtml(ref gump, 220, 340, 88, 25, $"<CENTER><BASEFONT COLOR=#ffffff>Cold</BASEFONT></CENTER>", false, false);
            Gumps.AddHtml(ref gump, 318, 340, 88, 25, $"<CENTER><BASEFONT COLOR=#ffffff>Poison</BASEFONT></CENTER>", false, false);
            Gumps.AddHtml(ref gump, 416, 340, 88, 25, $"<CENTER><BASEFONT COLOR=#ffffff>Energy</BASEFONT></CENTER>", false, false);

            Gumps.AddHtml(ref gump, 24, 372, 88, 25, $"<CENTER><BASEFONT COLOR=#ffffff>{myPet.ResistPhysical}% ({myPet.ResistPhysicalMaxRange}%)</BASEFONT></CENTER>", false, false);
            Gumps.AddHtml(ref gump, 122, 372, 88, 25, $"<CENTER><BASEFONT COLOR=#ffffff>{myPet.ResistFire}% ({myPet.ResistFireMaxRange}%)</BASEFONT></CENTER>", false, false);
            Gumps.AddHtml(ref gump, 220, 372, 88, 25, $"<CENTER><BASEFONT COLOR=#ffffff>{myPet.ResistCold}% ({myPet.ResistColdMaxRange}%)</BASEFONT></CENTER>", false, false);
            Gumps.AddHtml(ref gump, 318, 372, 88, 25, $"<CENTER><BASEFONT COLOR=#ffffff>{myPet.ResistPoison}% ({myPet.ResistPoisonMaxRange}%)</BASEFONT></CENTER>", false, false);
            Gumps.AddHtml(ref gump, 416, 372, 88, 25, $"<CENTER><BASEFONT COLOR=#ffffff>{myPet.ResistEnergy}% ({myPet.ResistEnergyMaxRange}%)</BASEFONT></CENTER>", false, false);
            ...
            Gumps.AddHtml(ref gump, 416, 462, 88, 25, $"<CENTER><BASEFONT COLOR=#ffffff>{(myPet.DamageEnergy == "---" ? "---" : $"{myPet.DamageEnergy}%")}</BASEFONT></CENTER>", false, false);
             ...
             //////////// SKILLS //////////////
            Gumps.AddHtml(ref gump, 10, 492, 512, 20, $"<CENTER><BASEFONT COLOR=#42a5ff>SKILLS</BASEFONT></CENTER>", false, false);
            Gumps.AddHtml(ref gump, 15, 522, 85, 25, $"<CENTER><BASEFONT COLOR=#ffffff>Wrestling</BASEFONT></CENTER>", false, false);
            Gumps.AddHtml(ref gump, 102, 522, 35, 25, $"<CENTER><BASEFONT COLOR=#ffffff>{myPet.WrestlingMin}</BASEFONT></CENTER>", false, false);
            Gumps.AddHtml(ref gump, 142, 522, 85, 25, $"<CENTER><BASEFONT COLOR=#ffffff>Meditation</BASEFONT></CENTER>", false, false);
            Gumps.AddHtml(ref gump, 229, 522, 35, 25, $"<CENTER><BASEFONT COLOR=#ffffff>{myPet.MeditationMin}</BASEFONT></CENTER>", false, false);
            Gumps.AddHtml(ref gump, 269, 522, 85, 25, $"<CENTER><BASEFONT COLOR=#ffffff>Necromancy</BASEFONT></CENTER>", false, false);
            Gumps.AddHtml(ref gump, 356, 522, 35, 25, $"<CENTER><BASEFONT COLOR=#ffffff>{myPet.NecromancyMin}</BASEFONT></CENTER>", false, false);
            Gumps.AddHtml(ref gump, 396, 522, 85, 25, $"<CENTER><BASEFONT COLOR=#ffffff>Mysticism</BASEFONT></CENTER>", false, false);
            Gumps.AddHtml(ref gump, 483, 522, 35, 25, $"<CENTER><BASEFONT COLOR=#ffffff>{myPet.MysticismMin}</BASEFONT></CENTER>", false, false);

            Gumps.AddHtml(ref gump, 15, 552, 85, 25, $"<CENTER><BASEFONT COLOR=#ffffff>Tactics</BASEFONT></CENTER>", false, false);
            Gumps.AddHtml(ref gump, 102, 552, 35, 25, $"<CENTER><BASEFONT COLOR=#ffffff>{myPet.TacticsMin}</BASEFONT></CENTER>", false, false);
            ...
            Gumps.AddHtml(ref gump, 15, 582, 85, 25, $"<CENTER><BASEFONT COLOR=#ffffff>Resist Spells</BASEFONT></CENTER>", false, false);
            Gumps.AddHtml(ref gump, 102, 582, 35, 25, $"<CENTER><BASEFONT COLOR=#ffffff>{myPet.ResistingSpellsMin}</BASEFONT></CENTER>", false, false);
            ...
            Gumps.AddHtml(ref gump, 15, 612, 85, 25, $"<CENTER><BASEFONT COLOR=#ffffff>Anatomy</BASEFONT></CENTER>", false, false);
            Gumps.AddHtml(ref gump, 102, 612, 35, 25, $"<CENTER><BASEFONT COLOR=#ffffff>{myPet.AnatomyMin}</BASEFONT></CENTER>", false, false);
            Gumps.AddHtml(ref gump, 142, 612, 85, 25, $"<CENTER><BASEFONT COLOR=#ffffff>Magery</BASEFONT></CENTER>", false, false);
            Gumps.AddHtml(ref gump, 229, 612, 35, 25, $"<CENTER><BASEFONT COLOR=#ffffff>{myPet.MageryMin}</BASEFONT></CENTER>", false, false);
            ...
            Gumps.AddHtml(ref gump, 396, 612, 85, 25, $"<CENTER><BASEFONT COLOR=#ffffff>Poisoning</BASEFONT></CENTER>", false, false);
            Gumps.AddHtml(ref gump, 483, 612, 35, 25, $"<CENTER><BASEFONT COLOR=#ffffff>{myPet.PoisoningMin}</BASEFONT></CENTER>", false, false);
            ...
            Gumps.AddHtml(ref gump, 142, 642, 85, 25, $"<CENTER><BASEFONT COLOR=#ffffff>Eval Int.</BASEFONT></CENTER>", false, false);
            Gumps.AddHtml(ref gump, 229, 642, 35, 25, $"<CENTER><BASEFONT COLOR=#ffffff>{myPet.EvalIntelligenceMin}</BASEFONT></CENTER>", false, false);
    ...
    public class Pet
    {
        ...
        public (string Rarity, string RarityColour, string Status) GetRarityStatus(Dictionary<string, string> rarityColours)
        {
            ...
            {
                return (targetPropTextString, targetRarityColour, targetStatus);
            }
            ...
            foreach (string keyword in keywords)
                {
                    ...
                    {
                        return (keyword, rarityColours[keyword], targetStatus);
                    }
                }
            // Return common if the pet isn't anything special.
            return ("Common", rarityColours["Common"], targetStatus);
        }
